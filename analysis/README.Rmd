...
tdew_mean_bias = round(with(tdew_model_validation, mean(tdew_idw_lapse_var - tdew, na.rm = T)), 2)
tdew_r2 = round(summary(lm(tdew ~ tdew_idw_lapse_var, tdew_model_validation))$r.squared, 2)
