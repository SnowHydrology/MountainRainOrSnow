...
In this second year of the project, we recorded `r length(obs2021$phase)` observations, `r round(length(filter(obs2021, tair_flag == "Pass" & ppt_flag == "Pass" & rh_flag == "Pass" & dist_flag == "Pass" & dupe_flag == "Pass")$phase)/length(obs2021$phase) * 100, digits = 1)`% of which passed the QC checks. 
