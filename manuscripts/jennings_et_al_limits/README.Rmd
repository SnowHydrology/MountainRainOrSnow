...
Figures 6 (map) and 7 (workflow infographic) are not summarized here. The data for the former are accessible via the source data links and the latter has no underlying data.
