...
cs_allphase_onlymet_rf_flow_tuned <- rf_flow_tuned
cs_allphase_onlymet_rf_param_best <- param_best
cs_allphase_onlymet_rf_tune_results <- rf_tune_results %>% collect_metrics()
...
# Save info from the tuning exercise
cs_nomix_onlymet_rf_flow_tuned <- rf_flow_tuned
cs_nomix_onlymet_rf_param_best <- param_best
cs_nomix_onlymet_rf_tune_results <- rf_tune_results %>% collect_metrics()
...
# Save info from the tuning exercise
cs_allphase_meteco_rf_flow_tuned <- rf_flow_tuned
cs_allphase_meteco_rf_param_best <- param_best
cs_allphase_meteco_rf_tune_results <- rf_tune_results %>% collect_metrics()
...
# Save info from the tuning exercise
cs_nomix_meteco_rf_flow_tuned <- rf_flow_tuned
cs_nomix_meteco_rf_param_best <- param_best
cs_nomix_meteco_rf_tune_results <- rf_tune_results %>% collect_metrics()
